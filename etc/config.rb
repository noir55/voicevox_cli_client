...
#  1: ずんだもん(あまあま)         11: 玄野武宏(ノーマル)         21: 剣崎雌雄(ノーマル)          31: No.7(読み聞かせ)      41: 玄野武宏(悲しみ)              51: †聖騎士 紅桜†(ノーマル)
#  2: 四国めたん(ノーマル)         12: 白上虎太郎(ふつう)         22: ずんだもん(ささやき)        32: 白上虎太郎(わーい)    42: ちび式じい(ノーマル)          52: 雀松朱司(ノーマル)
#  3: ずんだもん(ノーマル)         13: 青山龍星(ノーマル)         23: WhiteCUL(ノーマル)          33: 白上虎太郎(びくびく)  43: 櫻歌ミコ(ノーマル)            53: 麒ヶ島宗麟(ノーマル)
#  4: 四国めたん(セクシー)         14: 冥鳴ひまり(ノーマル)       24: WhiteCUL(たのしい)          34: 白上虎太郎(おこ)      44: 櫻歌ミコ(第二形態)            54: 春歌ナナ(ノーマル)
#  5: ずんだもん(セクシー)         15: 九州そら(あまあま)         25: Whitecul(かなしい)          35: 白上虎太郎(びえーん)  45: 櫻歌ミコ(ロリ)                55: 猫使アル(ノーマル)
...
VOICEVOX_CORRECT_MATRIX = {
  ...
  # ID      スピード      ピッチ  イントネーション  ボリューム
  "60" => [  1.00,        0.00,        1.00,        1.00  ],  # 61: 猫使ビィ(人見知り)
}
